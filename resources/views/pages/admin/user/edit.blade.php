                    ...
                    <form action="{{ route('data-user.update', $petugas->id_petugas) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="integer" name="telephone" class="form-control" value="{{ $petugas->telephone}}" required>
                            </div>
                            <div class="form-group">
                                <label for="">Email</label>
                                <input type="text" name="email" class="form-control" value="{{ $petugas->email}}" required>
                            </div>
                            <div class="form-group">
