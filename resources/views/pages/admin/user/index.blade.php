...
@section('content')
 ...
 <div class="main-content">
      ...
      <div class="card-header">
         <h4><a href="{{ route('data-user.create') }}" class="btn btn-icon icon-left btn-primary"><i class="far fa-tabel"></i> Tambah Data</a></h4>
         <form class="card-header-form"  method="get" action="{{ route('cariuser') }}">
            <div class="input-group">
              <input type="text" name="cariuser" class="form-control" id="cariuser" placeholder="Masukkan Nama">
        ...
        <div class="table-responsive">
            ...
            @foreach($user as $i => $us)
                <tr>
                  ...
                  <td>
                     <a href="{{ route('data-user.edit', $us->id_petugas)}}" class="btn btn-warning">Edit</a>
                     <form action="{{ route('data-user.destroy', $us->id_petugas) }}" class="d-inline" method="POST" id="delete{{$us->id_petugas}}">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-action delete-btn" data-toggle="tooltip"  >Hapus</button>
                        </form> 
                   </td>
                </tr>
               @endforeach
