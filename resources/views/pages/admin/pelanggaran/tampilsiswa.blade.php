                    ...
                    <div class="table-responsive">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>  <img widht="115px" height="65px" src="{{ asset('img/'. $sis->foto) }}" alt=""></td>
                              <td>
                                  <a href="{{url('/pilih_siswa/'.$sis->nisn)}}"class="btn btn-danger btn-action mr-1" data-toggle="tooltip">Pilih</a>
                              </td>
                          </tr>
