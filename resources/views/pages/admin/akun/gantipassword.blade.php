              ...
              <div class="col-7">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="wizard-content mt-1" action="{{ route('data-akun.update', Auth::user()->id_petugas) }}" method="POST">
                        @csrf
                        @method('PUT')
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-lg-6 col-md-6">
                          <input type="integer" name="telephone" class="form-control" value="{{ Auth::user()->telephone}}" required>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
