                    ...
                    <form class="wizard-content mt-1" action="" method="POST">
                      <div class="wizard-pane">
                        <div class="form-group row align-items-center">
                          ...
                          <label type="text" name="name" class="form-control">{{ Auth::user()->nama}}</label>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-left">Alamat</label>
                          <div class="col-lg-6 col-md-6">
                          <label type="text" name="name" class="form-control">{{ Auth::user()->alamat}}</label>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-left">Telephone</label>
                          <div class="col-lg-6 col-md-6">
                          <label type="text" name="name" class="form-control">{{ Auth::user()->telephone}}</label>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-left">Email</label>
                          <div class="col-lg-6 col-md-6">
                          <label type="text" name="name" class="form-control">{{ Auth::user()->email}}</label>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-left">Level</label>
                          <div class="col-lg-6 col-md-6">
                          <label type="text" name="name" class="form-control">{{ Auth::user()->level}}</label>
                          </div>
                        </div>
                      </div>
                    </form>
